...
# ADDED: lets you route around Cloudflare blocking Render's IP range.
# Point this at a Cloudflare Worker (or any reverse proxy) that forwards
# to https://animepahe.pw, and every request in anime_api.py will go
# through it instead of hitting animepahe.pw directly. If unset, behaves
# exactly as before (talks to animepahe.pw directly).
# Example: ANIMEPAHE_BASE_URL=https://your-worker.your-subdomain.workers.dev
ANIMEPAHE_BASE_URL = get_env_var("ANIMEPAHE_BASE_URL", "https://animepahe.pw", required=False).rstrip("/")
